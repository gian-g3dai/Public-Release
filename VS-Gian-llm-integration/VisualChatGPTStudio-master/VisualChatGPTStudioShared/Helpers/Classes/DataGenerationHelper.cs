...
{
    internal class DataGenerationHelper : BaseChatHelper, IChatHelper
    {
        public void RefreshChat(OpenAIService llm)
        {
            ...
            ChatMaster.ChatType = Constants.DATAGEN_ID;
        }

        public override void AppendUserInput(OpenAIService llm, string prompt)
        {
            CommandText = TurboChatHelper.GetChatName(Constants.DATAGEN_NAME);
            ...
            foreach (var item in detailList)
            {
                ...
                else
                {
                    ...
                    if (aurthor == AuthorEnum.Me && ChatItems.Count == 0)
                    {
                        ...
                        chatItem.SecondTag = "Data Generation";
                    }
